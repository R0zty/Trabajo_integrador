...
def consultar():
    while True: 
        try:
           ...
           csvfile.close()
           contador = 0
           for k,v in contactos in contactos:
               if int(contactos)['telefono'] == telefono:
                  contador += 1
                  print('Nombre del Contacto:', contactos['nombre'])
...
def modificar():
    ...
    try:
        ...
        for contacto in contactos:
            ...
            nuevo_telefono = int(input('Ingrese el telefono: '))
            nuevo_nombre = str(input('Ingrese nombre del contacto: '))
            nuevo_contacto = {}
